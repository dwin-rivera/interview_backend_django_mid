...
from interview.inventory.views import InventoryListRetrieveAfterDateView, InventoryLanguageListCreateView, InventoryLanguageRetrieveUpdateDestroyView, InventoryListCreateView, InventoryRetrieveUpdateDestroyView, InventoryTagListCreateView, InventoryTagRetrieveUpdateDestroyView, InventoryTypeListCreateView, InventoryTypeRetrieveUpdateDestroyView
...
urlpatterns = [
    ...
    path('date/<str:date>', InventoryListRetrieveAfterDateView.as_view(), name='inventory-list-after-date'),
